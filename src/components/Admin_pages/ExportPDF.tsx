...
export default function ExportPDF({ subscriptions }: Props) {
  ...
  const exportToPDF = () => {
    ...
    const headers = [
      [t('id', language), t('profile_id', language), t('start_date', language), 
       t('end_date', language), t('type', language), t('payment_method', language)]
    ];
  ...
  return (
    ...
    >
      {t('export_pdf', language) || 'Exporter PDF'}
    </button>
  );
}