      ...
      <div className="relative flex flex-row gap-2 bg-white border border-gray-300 shadow rounded-xl p-5">
        <div className="w-12 h-12 bg-[#33557D] rounded-3xl">
          <Image
            src={summation_sign}
            alt="summation_sign"
            className="relative left-[11px] top-[10px] w-[23px]"
          />
        </div>
        ...
        <div className="text-left">
          ...
          <p className="text-gray-500 text-sm">
            {t('total_subscriptions', language)}
          </p>
        </div>
        ...
        <Image
          src={blue_wave}
          alt="blue_wave"
          className="absolute top-17 right-2 pointer-events-none"
        />
      </div>
      ...
      <div className="relative flex flex-row gap-2 bg-white border border-gray-300 shadow rounded-xl p-5">
        <div className="w-12 h-12 bg-[#33557D] rounded-3xl">
          <Image
            src={refresh}
            alt="refresh"
            className="relative left-[7px] top-[7px]"
          />
        </div>
